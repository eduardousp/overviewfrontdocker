...
import { createListCarriers } from '@utils/mocks';

const listCarriers = createListCarriers(20);
listCarriers.sort((a, b) => Number(a.id) - Number(b.id));

const Carrier = () => {
  const [carriers] = useState(listCarriers);
