...
import { createListDeviceModels } from '@utils/mocks';

const listDeviceModels = createListDeviceModels(20);
listDeviceModels.sort((a, b) => Number(a.id) - Number(b.id));

const DeviceModel = () => {
  const [deviceModels] = useState(listDeviceModels);
