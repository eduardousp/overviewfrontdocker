...
export function ThirdPartySegmentsList({ data, className }: LinesListProp) {
  return (
    <div>
            ...
            {data.map((item) => {
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-4">
                    <span className="flex items-center min-w-[15rem] gap-2 text-base font-semibold text-gray-300">
                      Provedor de dados
                      <HelpTooltip>
                        Informação sobre o tópico que aparece ao se passar o mouse.
                      </HelpTooltip>
                    </span>
                    <span className="font-semibold text-blue-900">Nome (ID)</span>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <span className="font-semibold text-blue-900">R$ 0,50</span>
                  </div>
